...
st.title("Motor_vehicle_collisions_Crashes!")
st.markdown('### description yada yada yada')
...
st.subheader("Breakdown between %i:00 and %i:00"%(hour,(hour+1)%24))
filtered = data[
...
st.header("Top % dangerous street")
